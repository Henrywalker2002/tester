...
public class LoginController implements Initializable{
    ...
    public void Load() throws IOException, InterruptedException {
        BorderPane pane = FXMLLoader.load(getClass().getResource("f_files/Loading_Screen.fxml"));
                ...
                timer.schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        Platform.runLater(() -> {
                            ...
                            try {
                                adminPane = FXMLLoader.load(getClass().getResource("f_files/Admin_screen.fxml"));
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
                ...
                timer.schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        Platform.runLater(() -> {
                            ...
                            try {
                                userPane= FXMLLoader.load(getClass().getResource("f_files/User_screen.fxml"));
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
...
//            }
    ...
    void onSignUpClick(ActionEvent event) throws IOException {
        BorderPane pane = FXMLLoader.load(getClass().getResource("f_files/Registration_screen.fxml"));
        rootPane.getChildren().setAll(pane);
    }
    @Override
