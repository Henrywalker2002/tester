...
class TestEditProfile(BaseTestCase):
    ...
    def test_edit_success(self):
        ...
        self.command.execute(CommandChoices.PAUSE, amount=5)
        self.command.execute(CommandChoices.EDIT_CONTENT, target="xpath=//input[@name='firstname']", value="Pham")
        self.command.execute(CommandChoices.PAUSE, amount=5)
        self.command.execute(CommandChoices.EDIT_CONTENT, target="xpath=//input[@name='lastname']", value="Minh")
        self.command.execute(CommandChoices.PAUSE, amount=5)
        self.command.execute(CommandChoices.EDIT_CONTENT, target="xpath=//input[@name='city']", value="HCM")
        self.command.execute(CommandChoices.PAUSE, amount=5)
